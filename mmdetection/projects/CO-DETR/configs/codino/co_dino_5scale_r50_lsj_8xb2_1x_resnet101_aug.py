...
# load_from = "work_dirs/resnet101/total/iter_72000.pth"
# load_from = "work_dirs/resnet101/total_aug/iter_26000.pth"
...
albu_train_transforms = [
    ...
    #     p=0.2,
    # ),
    # dict(type="Cutout", num_holes=8, max_h_size=20, max_w_size=20, p=0.2),
...
img_scales = [(2048, 1280), (1024, 1024), (1333, 800), (640, 480)]
...
# lr_config = dict(
#     policy="step",  # learning rate adjustment policy, e.g., 'step', 'cosine', etc.
#     warmup="linear",  # type of warmup, e.g., 'linear', 'constant', 'exp'
#     warmup_iters=500,  # number of iterations to apply warmup
#     warmup_ratio=0.001,  # starting ratio of learning rate
#     step=[8, 11],  # epochs when to decrease the learning rate
# )
...
total_iters = max_epochs * iters_per_epoch  # Total number of iterations in the entire training
