...
load_from = "checkpoints/co_dino_5scale_lsj_r50_3x_coco-fe5a6829.pth"  # torchvision,restnet backbone pretrained model
...
# default_hooks = dict(
#     checkpoint=dict(by_epoch=True, save_last=True, interval=1, max_keep_ckpts=3)
# )
